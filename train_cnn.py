...
from Env_wrapper_cnn import PlanEnv
import cv2 
import warnings
...
def main():
    ...
    save_dir = f"trained_models_cnn_model_{timestamp}"
    os.makedirs(save_dir, exist_ok=True)

    checkpoint_interval = 15625*4 # checkpoint_interval * num_envs = total_steps_per_checkpoint
    checkpoint_callback = CheckpointCallback(save_freq=checkpoint_interval, save_path=save_dir, name_prefix="ppo_plan_cnn")
